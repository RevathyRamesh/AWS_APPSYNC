...
//revathyramesh
mongoose.connect(`mongodb+srv://${process.env.mongoUserName}:${process.env.mongoUserPassword}@grapgql-cluster.cz4xglm.mongodb.net/${process.env.mongoDatabase}?retryWrites=true&w=majority`,
